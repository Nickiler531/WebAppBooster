 ...
 * Web page: http://i-liger.com/article/android-wav-audio-recording
 */
package org.webappbooster.util;
                                                                              ...
                                                                              try {
                                                                                  ...
                                                                                  if (bSamples == 16) {
                                                                                      for (int i = 0; i < buffer.length / 2; i++) { // 16bit
                                                                                                                                    // sample
                                                                                                                                    // size
                                                                                          short curSample = getShort(
                                                                                                  buffer[i * 2],
                                                                                                  buffer[i * 2 + 1]);
                                                                                          if (curSample > cAmplitude) { // Check
                                                                                                                        // amplitude
